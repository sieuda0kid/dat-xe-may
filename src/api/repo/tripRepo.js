...
// 	var sql =  `insert into khachhang(customerName,customerPhone,customerAddress,isDelete) values('${cus.customerName}','${cus.customerPhone}','${cus.customerAddress}',${cus.isDelete})`;
// 	console.log(sql);
// 	return db.write(sql);
// }

// exports.loadTrip=function(cus){
// 	var sql = `select * from chuyen ORDER BY requestTime DESC`;
// 	console.log(sql);
// 	return db.write(sql);
// }
